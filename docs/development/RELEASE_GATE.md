...
9. TCP 8766 read-only source-complete live matrix；runtime command count 必須等於 source inventory 的 Extension-routed subset，blocked prerequisite 與 code fail 分開。
