...
1. Fork the repository and clone your fork:
   ...
   ```bash
   git clone https://github.com/<your-username>/IsaacSim-MCP.git
   cd IsaacSim-MCP
   ```
...
- **Ensure the bug was not already reported** by searching the existing [GitHub Issues](https://github.com/Tim0320/IsaacSim-MCP/issues).
- If you cannot find an open issue addressing the problem, [open a new one](https://github.com/Tim0320/IsaacSim-MCP/issues/new/choose). Use the **Bug Report** template and fill in as much detail as possible.

## Do You Want to Request a Feature?

- Check the [existing feature requests](https://github.com/Tim0320/IsaacSim-MCP/issues?q=label%3A%22Feature+request%22) to see if someone has already proposed it.
- If not, [open a new feature request](https://github.com/Tim0320/IsaacSim-MCP/issues/new/choose) using the **Feature Request** template.
...
If you have questions about contributing, feel free to open a [Discussion](https://github.com/Tim0320/IsaacSim-MCP/discussions) or an issue.
